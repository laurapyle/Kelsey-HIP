...
There were `r N` subjects included in this analysis.  Descriptive statisitcs are shown in Table 1.

```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab1,caption="Table 1.  Descriptive statistics by study group.")
```

There were no differences between the groups in the changes in the primary outcomes, in unadjusted analyses (Table 2).

```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab_unadjusted,caption="Table 2.  Unadjusted changes in primary outcomes.")
```
...
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab2,caption="Table 3.  Change in insulin sensitivity, adjusting for sex, race/ethnicity, and baseline Tanner stage.")
```
\
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab3,caption="Table 4.  Change in insulin secretion, adjusting for sex, race/ethnicity, and baseline Tanner stage.")
```
\
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab4,caption="Table 5.  Change in DI, adjusting for sex, race/ethnicity, and baseline Tanner stage.")
```
