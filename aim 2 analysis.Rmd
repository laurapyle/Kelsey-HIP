...
table(wide$Randomization.Group)
...
# need to fix reference group for race and treatment group
# are there no NHW kids?
rand$race_eth <- relevel(as.factor(rand$race_eth),ref='NHW')
...
tab2 <- mod_tab(adj2)
tab2$Predictor <- c("Group - Met vs. Placebo","Male vs. Female", "Asian vs. NHW","Black vs. NHW","Hispanic vs. NHW","Other race/ethnicity vs. NHW","Tanner stage 3 vs. stage 2")
